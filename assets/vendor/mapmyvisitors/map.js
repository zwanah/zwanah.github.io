...
function main() {
    ...
    function bgUrl(data) {
        var base = 'https://mapmyvisitors.com/generated_content/backs/bg';
        var ap = ['w', 'co', 'cl'];
        var p = [];
        for ( var i in ap ) {
           var v = ap[i];
    ...
    function counterCode() {
        ...
        $.ajax({
            ...
            cache: false,
            data: data,
            url: "https://mapmyvisitors.com/widget_call_home.js",
...
function embed_counter(script_el, embed_after_script){
    if($('#mapmyvisitors-widget').length === 0){
                            var link = '<a target="_top" href="https://mapmyvisitors.com/" id="mapmyvisitors-widget">';
